...
> **File này trả lời:** từ baseline demo đến TSR feature production khác nhau ở đâu, và roadmap repo nên đi theo chuỗi nào.  
...
| Tài liệu chuyên đề | [2.research_tsr_baseline_analysis.md](2.research_tsr_baseline_analysis.md) (gắn `tsr_demo.py`), [3.research_tsr_detection_architecture_research.md](3.research_tsr_detection_architecture_research.md) (kiến trúc detector), [4.research_tsr_colab_production_lite_demo.md](4.research_tsr_colab_production_lite_demo.md) (production-lite replay) |
| Tài liệu dẫn xuất | [diagram.md](diagram.md) (visual appendix), [slide.md](slide.md) (slide deck) |
...
| **1** | `1.research_tsr_three_part_unified.md` | Narrative chính: problem framing, production mindset, gap baseline, roadmap (file này) |
| **2** | `2.research_tsr_baseline_analysis.md` | Annex gắn repo: `tsr_demo.py`, `best.pt`, runtime, gap implementation |
| **3** | `3.research_tsr_detection_architecture_research.md` | Deep-dive detector: anchor, neck, NMS, small-object, dataset, edge deploy |
| **4** | `4.research_tsr_colab_production_lite_demo.md` | Notebook production-lite: stateful replay, JSONL, quality/ODD gate |
| **5** | `diagram.md` | Visual appendix và glossary ngắn cho các block kiến trúc |
| **6** | `slide.md` | Presentation derivative; sửa narrative chính ở file này sau khi đã sửa `1...` |
| **7** | `sources.md` | Trích dẫn và provenance |
