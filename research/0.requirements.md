...
- Để đạt ngưỡng phân loại tin cậy $P_{sign} = 48\text{ pixels}$, khoảng cách phát hiện tối đa của camera $6\text{ mm}$ là:
  $$D_{classify\_max} = \frac{0.875 \times 0.006}{48 \times (3.0 \times 10^{-6})} \approx 36.46\text{ m}$$
- Khi xe đến cách biển $36.46\text{ m}$, thời gian xe lướt qua biển chỉ còn:
  $$t = \frac{36.46}{33.33} \approx 1.09\text{ giây}$$
