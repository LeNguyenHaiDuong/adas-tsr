...
- repo hiện đã có notebook sidecar [07.tsr_colab_production_lite_demo.ipynb](07.tsr_colab_production_lite_demo.ipynb) để demo quality gate, track lifecycle, `events.jsonl` và KPI proxy trên Colab;
