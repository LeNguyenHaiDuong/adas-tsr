...
4. **Asynchronous Multi-Threading & POSIX Real-Time Systems:**
   - IEEE Std 1003.1c-1995. *POSIX Part 1: System Application Program Interface (API) - Amendment 2: Threads Extension (C Language)*. IEEE Computer Society.
5. **Automotive Hardware Reliability & Functional Safety:**
   ...
   - NVIDIA Corporation. *Jetson Nano Developer Kit Thermal Design Guide & Technical Reference Manual*. 2021.
...
| Tình Huống Giả Lập | Kỹ Thuật Biến Đổi OpenCV | KPI Quan Sát & Kiểm Chứng |
|---|---|---|
...
| **Sương mù dày đặc (Dense Fog)** | Pha trộn ảnh với mặt nạ xám đồng nhất: $I_{fog} = lpha I + (1-lpha) L_{air}$ với $lpha = 0.55$. | Quality Gate có chuyển sang chế độ `DEGRADED_VISIBILITY` và kéo dài TTL không? |
