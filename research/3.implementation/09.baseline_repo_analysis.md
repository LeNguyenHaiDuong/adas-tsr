...
> **Folder index:** [3.00. Implementation Index](00.index.md) — Lấy: cấu trúc implementation layer và thứ tự đọc. Dùng ở: điều hướng từ baseline overview sang notebook, benchmark và full reference.
>
> **Vai trò file này:** điểm vào implementation cho baseline repo.
>
> **Detailed reference:** [3.12. Baseline Repo Analysis Full Reference](12.baseline_repo_analysis_full.md) — Lấy: phân tích đầy đủ runtime, model, dataset và gap production. Dùng ở: chứng minh baseline hiện tại chỉ là detector demo, chưa phải feature TSR production.
