...
> **Thứ tự đọc:** đọc sau narrative chính và baseline analysis nếu cần demo stateful replay.  
...
> **Notebook đi kèm:** [07.tsr_colab_production_lite_demo.ipynb](07.tsr_colab_production_lite_demo.ipynb)  
...
1. Mở notebook [07.tsr_colab_production_lite_demo.ipynb](07.tsr_colab_production_lite_demo.ipynb) trên Colab.
...
4. KPI cell hiện tại và GT schema có đủ cho demo / review nội bộ hay cần thêm field hoặc thêm chart.
...
- Tài liệu chính: [Unified Production Reference](../2.knowledge_base/12.unified_production_reference.md)
- Phân tích baseline: [Baseline Repo Analysis Full](04.baseline_repo_analysis_full.md)
- Nghiên cứu detector: [Detector Architecture Deep Reference](../2.knowledge_base/13.detector_architecture_deep_reference.md)
- Notebook mới: [07.tsr_colab_production_lite_demo.ipynb](07.tsr_colab_production_lite_demo.ipynb)
