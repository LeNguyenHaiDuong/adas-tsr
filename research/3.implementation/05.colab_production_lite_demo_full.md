...
| [Detector Architecture Deep Reference](../2.knowledge_base/13.detector_architecture_deep_reference.md) | Chấp nhận giới hạn của YOLO baseline về small-object, latency và long-tail; notebook không cố thay detector |
