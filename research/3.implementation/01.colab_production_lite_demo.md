...
>
> **Detailed reference:** [3.07. Colab Production-Lite Demo Full Reference](07.colab_production_lite_demo_full.md) — Lấy: giải thích đầy đủ các block production-lite trong notebook. Dùng ở: mô tả ODD/quality gate, tracking, state lifecycle, HMI warning và replay log.
>
...
- các chi tiết công thức nằm ở [3.02. Notebook Analyze](02.notebook_analyze.md), không lặp lại trong file này.
...
Khi cần biết notebook thật sự đã code gì và chưa code gì, đọc [3.03. Notebook Technique Audit](03.notebook_technique_audit.md). Khi cần mô tả chi tiết để đưa vào báo cáo, đọc [3.07. Colab Production-Lite Demo Full](07.colab_production_lite_demo_full.md).
