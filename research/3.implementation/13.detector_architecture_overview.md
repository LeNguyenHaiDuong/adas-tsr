...
>
> **[SRC] Bài đọc sâu hơn:** [3.10. Detector Architecture Deep Reference](10.detector_architecture_deep_reference.md) — Lấy: chi tiết anchor/head/NMS/multi-scale fusion/edge deployment. Dùng ở: các mục trade-off detector và hướng đọc sâu.
>
> **Nguồn chính:**
>
...
> - [2.06. Sources and Provenance](../2.knowledge_base/06.sources_and_provenance.md) `[SRC]` — Lấy: quy ước `[SRC]` và danh mục evidence nội bộ. Dùng ở: tách claim kiến trúc detector khỏi evidence baseline repo.

---

## Purpose

> **Nguồn tại mục:** [3.10. Detector Architecture Deep Reference](10.detector_architecture_deep_reference.md) `[SRC]` — Lấy: danh sách trade-off detector cần soi cho TSR. Dùng ở: các chủ đề YOLO, RT-DETR, anchor, head, NMS, neck và small-object.
>
...
> **Nguồn tại mục:** [3.09. Baseline Repo Analysis](09.baseline_repo_analysis.md) `[SRC]` — Lấy: checkpoint `best.pt`, YOLO11s, CPU runtime và detector output hiện tại. Dùng ở: mô tả prototype repo.
>
...
>
> **Nguồn tại mục:** [3.10. Detector Architecture Deep Reference](10.detector_architecture_deep_reference.md) `[SRC]` — Lấy: small-object, benchmark, architecture-change questions. Dùng ở: ba câu hỏi kiến trúc cuối mục.
...
1. Bài đọc sâu hơn: [3.10. Detector Architecture Deep Reference](10.detector_architecture_deep_reference.md) `[SRC]`
2. [3.14. Dataset and Benchmark Guide](14.dataset_and_benchmark_guide.md) `[SRC]`
3. [3.09. Baseline Repo Analysis](09.baseline_repo_analysis.md) `[SRC]`
