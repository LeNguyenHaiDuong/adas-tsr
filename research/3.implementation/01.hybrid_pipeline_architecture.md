...
Runtime hiện tại xử lý tuần tự. Khi nâng lên production-lite edge, có thể tách luồng:

```mermaid
flowchart LR
    A[Capture Thread] --> Q1[Frame Queue]
    Q1 --> B[Inference Worker]
    B --> Q2[Detection Queue]
    Q2 --> C[State Manager]
    C --> D[HMI/Logger/Video Writer]
```
