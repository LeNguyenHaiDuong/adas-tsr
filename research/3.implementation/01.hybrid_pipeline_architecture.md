...
- $v$: Tham số đo lường tính nhất quán của tỷ lệ khung hình (Aspect Ratio Consistency):
  $$v = \frac{4}{\pi^2} \left( \arctan\frac{w^{gt}}{h^{gt}} - \arctan\frac{w}{h} \right)^2$$
- $\alpha$: Trọng số cân bằng:
...
- **Màu đỏ (Biển cấm / nguy hiểm)**: Do kênh Hue đỏ nằm ở 2 đầu dải quang phổ, ta dùng hợp của 2 dải:
  $$\text{Red}_1: H \in [0, 10], S \in [70, 255], V \in [50, 255]$$
  $$\text{Red}_2: H \in [170, 180], S \in [70, 255], V \in [50, 255]$$
...
- **Phép mở (Opening)** để khử các đốm nhiễu hạt nhỏ do lá cây hoặc đèn đường:
  $$A \circ B = (A \ominus B) \oplus B$$
- **Phép đóng (Closing)** để hàn gắn các vết nứt, đứt đoạn trên viền tròn của biển báo do đọng nước hoặc bóng râm:
