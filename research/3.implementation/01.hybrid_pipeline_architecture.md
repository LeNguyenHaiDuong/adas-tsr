...
<!-- consolidated-from: research/3.implementation/00.index.md -->

## Phụ Lục Hợp Nhất Từ `research/3.implementation/00.index.md`

> Phần này được gộp từ `research/3.implementation/00.index.md` để giữ lại nội dung và traceability sau khi rút gọn cấu trúc Markdown.
...
Prompt v3 đặt implementation layer sau Knowledge Base. Luồng chính ở đây hiện thực hóa trực tiếp yêu cầu về pipeline lai, state manager/HMI, edge deployment và production-lite demo.
...
| Nhóm | File | Vai trò |
|---|---|---|
| Notebook overview legacy | [Colab Production-Lite Demo](03.edge_deployment_and_benchmarks.md) | Overview ngắn của artifact notebook hiện tại |
...
| Benchmark guide legacy | [Experiment and Benchmark Guide](03.edge_deployment_and_benchmarks.md) | Protocol benchmark và artifact cần chuẩn hóa |
| Baseline runtime | [Baseline Repo Analysis](01.hybrid_pipeline_architecture.md) | Context cho runtime legacy `code/tsr_demo.py` |
...
| Runtime script legacy overview | [3.09. Baseline Repo Analysis](01.hybrid_pipeline_architecture.md) |
| Runtime script legacy full reference | [3.12. Baseline Repo Analysis Full](01.hybrid_pipeline_architecture.md) |
...
| Luồng implementation tuyến tính mới | [3.01. Hybrid Pipeline Architecture](01.hybrid_pipeline_architecture.md), [3.02. State Manager and HMI](02.state_manager_and_hmi.md), [3.03. Edge Deployment and Benchmarks](03.edge_deployment_and_benchmarks.md), [3.04. Production-Lite Demo Notebook](03.edge_deployment_and_benchmarks.md) |
...
- [3.12. Baseline Repo Analysis Full Reference](01.hybrid_pipeline_architecture.md)
- [3.13. Detector Architecture Overview](01.hybrid_pipeline_architecture.md) — shortcut cũ, optional
- [3.14. Dataset and Benchmark Guide](03.edge_deployment_and_benchmarks.md) — shortcut cũ, optional


---

<!-- consolidated-from: research/3.implementation/09.baseline_repo_analysis.md -->

## Phụ Lục Hợp Nhất Từ `research/3.implementation/09.baseline_repo_analysis.md`

> Phần này được gộp từ `research/3.implementation/09.baseline_repo_analysis.md` để giữ lại nội dung và traceability sau khi rút gọn cấu trúc Markdown.
...
>
> **Detailed reference:** [3.12. Baseline Repo Analysis Full Reference](01.hybrid_pipeline_architecture.md) — Lấy: phân tích đầy đủ runtime, model, dataset và gap production. Dùng ở: chứng minh baseline hiện tại chỉ là detector demo, chưa phải feature TSR production.
...
<!-- consolidated-from: research/3.implementation/10.detector_architecture_deep_reference.md -->

## Phụ Lục Hợp Nhất Từ `research/3.implementation/10.detector_architecture_deep_reference.md`

> Phần này được gộp từ `research/3.implementation/10.detector_architecture_deep_reference.md` để giữ lại nội dung và traceability sau khi rút gọn cấu trúc Markdown.

## Detector Architecture Implementation Reference — TSR

> **Thứ tự đọc:** 10 — đọc sau [3.09. Baseline Repo Analysis](01.hybrid_pipeline_architecture.md) `[SRC]`; mở [3.12. Baseline Repo Analysis Full](01.hybrid_pipeline_architecture.md) `[SRC]` khi cần evidence chi tiết. Dùng ở: đặt các trade-off anchor/head/NMS vào đúng bối cảnh repo.
>
...
>
> **[SRC] Ngoài phạm vi:** kể lại production pipeline TSR từ đầu đến cuối; narrative đó nằm ở [2.04. Unified Production Reference](../2.knowledge_base/01.automotive_standards.md) — Lấy: lifecycle, ODD, HMI và release context. Dùng ở: điều hướng khi detector trade-off cần nối sang feature/system behavior.
...
| Liên kết triển khai repo | [3.12. Baseline Repo Analysis Full](01.hybrid_pipeline_architecture.md) `[SRC]` |
| Liên kết narrative hệ thống | [2.04. Unified Production Reference](../2.knowledge_base/01.automotive_standards.md) `[SRC]` |
...
> **Nguồn tại mục:** [3.12. Baseline Repo Analysis Full](01.hybrid_pipeline_architecture.md) `[SRC]` — Lấy: detector baseline hiện tại, gap runtime và câu hỏi implementation còn mở. Dùng ở: tóm tắt small-object, temporal stability và edge deployment.
>
...
- Khi cần trace biểu hiện của các trade-off này trong repo hiện tại, quay lại [3.12. Baseline Repo Analysis Full](01.hybrid_pipeline_architecture.md) — evidence implementation về baseline detector và gap runtime.
- Khi cần hệ quả system-level lên HMI, diagnostics hay maturity, quay lại [2.04. Unified Production Reference](../2.knowledge_base/01.automotive_standards.md) — deep dive production cho feature TSR đầy đủ.
...
> **Nguồn tại mục:** [3.12. Baseline Repo Analysis Full](01.hybrid_pipeline_architecture.md) `[SRC]` — Lấy: baseline hiện tại `Ultralytics YOLO11s`, CPU runtime và gap implementation. Dùng ở: dòng prototype CPU/current weights.
>
...
>
> **Nguồn tại mục:** [3.12. Baseline Repo Analysis Full](01.hybrid_pipeline_architecture.md) `[SRC]` — Lấy: `preprocess()`, `max_width`, `imgsz`, `non_max_suppression_simple()` và gap bbox-size KPI. Dùng ở: công thức resize, gap repo và implementation pattern.
>
...
> **Nguồn tại mục:** [3.12. Baseline Repo Analysis Full](01.hybrid_pipeline_architecture.md) `[SRC]` — Lấy: gap `max_width`, `imgsz`, NMS area-sort và thiếu size-bin KPI. Dùng ở: root cause các ví dụ small sign/miss/NMS.
>
...
> **Nguồn tại mục:** [3.12. Baseline Repo Analysis Full](01.hybrid_pipeline_architecture.md) `[SRC]` — Lấy: runtime hiện tại resize theo `max_width`, dùng một `imgsz`, NMS sort theo diện tích và chưa có bin KPI. Dùng ở: bảng gap repo hiện tại.
...
> **Nguồn tại mục:** [3.12. Baseline Repo Analysis Full](01.hybrid_pipeline_architecture.md) `[SRC]` — Lấy: baseline dataset/model hiện tại, long-tail và missing dataset artifacts. Dùng ở: gap dataset card, scenario matrix, split protocol và per-class/size KPI.
...
>
> **Nguồn tại mục:** [3.12. Baseline Repo Analysis Full](01.hybrid_pipeline_architecture.md) `[SRC]` — Lấy: repo hiện chưa có export/parity protocol. Dùng ở: gap/deployment steps.
...
>
> **Nguồn tại mục:** [3.12. Baseline Repo Analysis Full](01.hybrid_pipeline_architecture.md) `[SRC]` — Lấy: runtime gap hiện tại. Dùng ở: parity checker và benchmark protocol.
...
> **Nguồn tại mục:** [3.12. Baseline Repo Analysis Full](01.hybrid_pipeline_architecture.md) `[SRC]` — Lấy: repo hiện chỉ hướng dẫn PyTorch/Ultralytics inference, chưa có export/parity/calibration/runtime wrapper. Dùng ở: gap edge deployment.
>
...
>
> **Nguồn tại mục:** [3.12. Baseline Repo Analysis Full](01.hybrid_pipeline_architecture.md) `[SRC]` — Lấy: nhánh traditional heuristic không đọc giá trị speed và runtime hiện không có OCR. Dùng ở: dòng `--traditional` heuristic.
...
> **Nguồn tại mục:** [3.12. Baseline Repo Analysis Full](01.hybrid_pipeline_architecture.md) `[SRC]` — Lấy: runtime hiện không có OCR/digit branch/canonicalization/plausibility check. Dùng ở: bảng gap repo.
...
> **Nguồn tại mục:** [3.12. Baseline Repo Analysis Full](01.hybrid_pipeline_architecture.md) `[SRC]` — Lấy: baseline dùng global confidence threshold, chưa có ECE/reliability/calibration artifact. Dùng ở: bảng gap repo.
>
...
>
> **Nguồn tại mục:** [3.12. Baseline Repo Analysis Full](01.hybrid_pipeline_architecture.md) `[SRC]` — Lấy: repo hiện chưa có feature-layer event KPI/export parity/ODD validation. Dùng ở: gap benchmark và yêu cầu lock protocol.
>
...
<!-- consolidated-from: research/3.implementation/12.baseline_repo_analysis_full.md -->

## Phụ Lục Hợp Nhất Từ `research/3.implementation/12.baseline_repo_analysis_full.md`

> Phần này được gộp từ `research/3.implementation/12.baseline_repo_analysis_full.md` để giữ lại nội dung và traceability sau khi rút gọn cấu trúc Markdown.
...
>
> **Ngoài phạm vi:** giải thích đầy đủ production framework, V-model, safety/SOTIF hay kiến trúc tổng thể; phần đó nằm ở [2.04. Unified Production Reference](../2.knowledge_base/01.automotive_standards.md) — Lấy: kiến trúc production và roadmap hệ thống. Dùng ở: điều hướng khi gap baseline cần giải thích ở level feature/system.
...
| Liên kết hệ thống | [2.04. Unified Production Reference](../2.knowledge_base/01.automotive_standards.md) |
...
- Khi cần lý do hệ thống-level "vì sao detector chưa phải feature", quay lại [2.04. Unified Production Reference](../2.knowledge_base/01.automotive_standards.md) — deep dive production về feature TSR đầy đủ.
...
Chi tiết về KPI system-level, release gate, scenario catalog, diagnostics và readiness đã được giữ ở [2.04. Unified Production Reference](../2.knowledge_base/01.automotive_standards.md) §II.10–§II.18. Trong file này, các framework đó chỉ còn vai trò **mapping**: repo hiện có thiếu artifact nào và nên bổ sung gì trước.
...
Mô hình trưởng thành đầy đủ đã có trong [2.04. Unified Production Reference](../2.knowledge_base/01.automotive_standards.md). Từ góc nhìn repo, có thể rút gọn thành bảng sau:
...
<!-- consolidated-from: research/3.implementation/13.detector_architecture_overview.md -->

## Phụ Lục Hợp Nhất Từ `research/3.implementation/13.detector_architecture_overview.md`

> Phần này được gộp từ `research/3.implementation/13.detector_architecture_overview.md` để giữ lại nội dung và traceability sau khi rút gọn cấu trúc Markdown.
