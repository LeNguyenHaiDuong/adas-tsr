...
> **Folder index:** [3.00. Implementation Index](00.index.md) — Lấy: cấu trúc implementation layer và thứ tự đọc. Dùng ở: điều hướng người đọc từ full baseline analysis sang overview/notebook/benchmark.
>
> **File này trả lời:** baseline repo hiện tại làm được gì, thiếu gì, và gap đó biểu hiện ra sao trên runtime thực tế.
>
> **Ngoài phạm vi:** giải thích đầy đủ production framework, V-model, safety/SOTIF hay kiến trúc tổng thể; phần đó nằm ở [2.01. Unified Production Reference](../2.knowledge_base/01.unified_production_reference.md) — Lấy: kiến trúc production và roadmap hệ thống. Dùng ở: điều hướng khi gap baseline cần giải thích ở level feature/system.
...
| Liên kết kiến trúc detector | [3.06. Detector Architecture Deep Reference](06.detector_architecture_deep_reference.md) |
| Liên kết hệ thống | [2.01. Unified Production Reference](../2.knowledge_base/01.unified_production_reference.md) |
| Liên kết notebook production-lite | [3.07. Colab Production-Lite Demo Full](07.colab_production_lite_demo_full.md) |
...
- Khi cần lý do hệ thống-level "vì sao detector chưa phải feature", quay lại [2.01. Unified Production Reference](../2.knowledge_base/01.unified_production_reference.md) — deep dive production về feature TSR đầy đủ.
- Khi cần theory detector, quay lại [3.06. Detector Architecture Deep Reference](06.detector_architecture_deep_reference.md) — phân tích kiến trúc detector, NMS, multi-scale và edge deployment.
...
Mô hình trưởng thành đầy đủ đã có trong [2.01. Unified Production Reference](../2.knowledge_base/01.unified_production_reference.md). Từ góc nhìn repo, có thể rút gọn thành bảng sau:
