...
- repo hiện đã có thêm notebook sidecar [07.tsr_colab_production_lite_demo.ipynb](07.tsr_colab_production_lite_demo.ipynb) mô phỏng `quality gate`, `ODD gate`, `IoU tracking`, `track lifecycle`, `warning level`, `events.jsonl`, KPI proxy và optional GT eval;
