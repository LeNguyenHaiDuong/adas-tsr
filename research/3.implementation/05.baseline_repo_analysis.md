...
>
> **Detailed reference:** [3.08. Baseline Repo Analysis Full Reference](08.baseline_repo_analysis_full.md) — Lấy: phân tích đầy đủ runtime, model, dataset và gap production. Dùng ở: chứng minh baseline hiện tại chỉ là detector demo, chưa phải feature TSR production.
