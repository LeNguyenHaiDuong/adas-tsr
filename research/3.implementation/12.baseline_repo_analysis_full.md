...
>
> **Ngoài phạm vi:** giải thích đầy đủ production framework, V-model, safety/SOTIF hay kiến trúc tổng thể; phần đó nằm ở [2.04. Unified Production Reference](../2.knowledge_base/04.unified_production_reference.md) — Lấy: kiến trúc production và roadmap hệ thống. Dùng ở: điều hướng khi gap baseline cần giải thích ở level feature/system.
...
| Liên kết kiến trúc detector | [3.10. Detector Architecture Deep Reference](10.detector_architecture_deep_reference.md) |
| Liên kết hệ thống | [2.04. Unified Production Reference](../2.knowledge_base/04.unified_production_reference.md) |
| Liên kết notebook production-lite | [3.11. Colab Production-Lite Demo Full](11.colab_production_lite_demo_full.md) |
...
- Khi cần lý do hệ thống-level "vì sao detector chưa phải feature", quay lại [2.04. Unified Production Reference](../2.knowledge_base/04.unified_production_reference.md) — deep dive production về feature TSR đầy đủ.
- Khi cần theory detector, quay lại [3.10. Detector Architecture Deep Reference](10.detector_architecture_deep_reference.md) — phân tích kiến trúc detector, NMS, multi-scale và edge deployment.
...
Chi tiết về KPI system-level, release gate, scenario catalog, diagnostics và readiness đã được giữ ở [2.04. Unified Production Reference](../2.knowledge_base/04.unified_production_reference.md) §II.10–§II.18. Trong file này, các framework đó chỉ còn vai trò **mapping**: repo hiện có thiếu artifact nào và nên bổ sung gì trước.
...
Mô hình trưởng thành đầy đủ đã có trong [2.04. Unified Production Reference](../2.knowledge_base/04.unified_production_reference.md). Từ góc nhìn repo, có thể rút gọn thành bảng sau:
