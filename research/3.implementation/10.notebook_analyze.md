...
CLAHE là biến thể của histogram equalization. Điểm khác biệt nằm ở hai ý chính:
...
Gọi bốn ánh xạ lân cận là $M_{00}$, $M_{10}$, $M_{01}$, $M_{11}$. Với pixel nằm tại vị trí tương đối $\alpha$ theo chiều ngang và $\beta$ theo chiều dọc giữa các tile:
...
Nội suy này giữ hiệu ứng tăng tương phản cục bộ nhưng làm mượt chuyển tiếp giữa các tile.
...
BGR frame
  ...
  -> new L value through tile LUT and interpolation
