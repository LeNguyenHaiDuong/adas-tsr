...
> **[SRC] Narrative entrypoint:** [Prototype to Production Narrative](../1.narrative/01.prototype_to_production.md) — Lấy: ranh giới giữa demo chạy được và feature có điều kiện vận hành rõ. Dùng ở: mở bài để gắn ODD với scope TSR production.
>
> **[SRC] Full reference:**
>
> - [Unified Production Reference](12.unified_production_reference.md) — Lấy: ODD taxonomy, degraded behavior và release gate theo ODD slice. Dùng ở: thiết kế ODD gate và behavior khi input ngoài phạm vi.
> - [Colab Production-Lite Demo Full](../3.implementation/05.colab_production_lite_demo_full.md) — Lấy: evidence `quality_gate`, `odd_gate`, skip inference và replay log. Dùng ở: phần liên hệ ODD lý thuyết với notebook production-lite.
>
> **Nguồn chính:**
>
...
> - [Sources and Provenance](11.sources_and_provenance.md) `[SRC]` — Lấy: quy ước `[SRC]` và danh mục evidence nội bộ. Dùng ở: phân biệt ODD claim từ notebook với claim từ chuẩn/paper.
...
>
> **Nguồn tại mục:** [Colab Production-Lite Demo Full](../3.implementation/05.colab_production_lite_demo_full.md) `[SRC]` — Lấy: quality/ODD gate và reason_code trong notebook. Dùng ở: giải thích vì sao cần threshold để gate/suppress.
>
...
>
> **Nguồn tại mục:** [Colab Production-Lite Demo Full](../3.implementation/05.colab_production_lite_demo_full.md) `[SRC]` — Lấy: notebook có `quality score`, `reason_code`, `feature_state`/skip behavior. Dùng ở: monitor ví dụ cho out-of-ODD.
...
> **Nguồn tại mục:** [Baseline Repo Analysis](../3.implementation/01.baseline_repo_analysis.md) `[SRC]` — Lấy: baseline runtime chưa có lane/map applicability, timing contract ECU và ODD tagging đầy đủ. Dùng ở: danh sách ODD hẹp của prototype.
>
> **Nguồn tại mục:** [Colab Production-Lite Demo](../3.implementation/02.colab_production_lite_demo.md) `[SRC]` — Lấy: production-lite notebook thêm quality/ODD gate nhưng vẫn là demo. Dùng ở: đánh giá phạm vi hiện tại của repo.
...
> **Nguồn tại mục:** [Experiment and Benchmark Guide](../3.implementation/03.experiment_benchmark_guide.md) `[SRC]` — Lấy: benchmark phải khóa input/protocol và phân tích theo điều kiện test. Dùng ở: cảnh báo demo đẹp/clip xấu không đại diện nếu không nêu ODD.
>
