...
> **[SRC] Narrative entrypoint:** [Prototype to Production Narrative](../1.narrative/01.prototype_to_production.md) — Lấy: bối cảnh dataset/benchmark không chỉ phục vụ mAP mà còn release confidence. Dùng ở: mở bài và phần source-of-truth benchmark.
>
> **[SRC] Bài đọc sâu hơn:**
>
> - [Detector Architecture Deep Reference](13.detector_architecture_deep_reference.md) — Lấy: metric/trade-off detector ảnh hưởng benchmark. Dùng ở: phần chọn dataset theo small object, NMS và edge latency.
> - [Sources and Provenance](11.sources_and_provenance.md) — Lấy: danh mục nguồn dataset/model và quy ước evidence. Dùng ở: source-of-truth khi mô tả baseline dataset.
>
> **Nguồn chính:**
>
...
> **Nguồn tại mục:** [Detector Architecture Deep Reference](13.detector_architecture_deep_reference.md) `[SRC]` — Lấy: vai trò dataset/benchmark trong detector choice, small object và deployment. Dùng ở: phạm vi “dataset và benchmark framing”.
...
> **Nguồn tại mục:** [Baseline Repo Analysis](../3.implementation/01.baseline_repo_analysis.md) `[SRC]` — Lấy: baseline dùng `models/best.pt`, YOLO11s và runtime hiện tại. Dùng ở: mô tả dependency của prototype.
>
...
> **Nguồn tại mục:** [Experiment and Benchmark Guide](../3.implementation/03.experiment_benchmark_guide.md) `[SRC]` — Lấy: protocol benchmark cần khóa clip, tham số và logging. Dùng ở: các rule thực dụng đầu tiên.
>
> **Nguồn tại mục:** [Detector Architecture Deep Reference](13.detector_architecture_deep_reference.md) `[SRC]` — Lấy: cần tách frame-level metric, feature-level behavior, size-bin và scenario tags. Dùng ở: rule metric/logging.
...
- Bài đọc sâu hơn: [Detector Architecture Deep Reference](13.detector_architecture_deep_reference.md) `[SRC]`
