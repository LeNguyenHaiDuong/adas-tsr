...
>
> **[SRC] Full reference:** [2.04. Unified Production Reference](04.unified_production_reference.md) — Lấy: SOTIF trigger catalog, ODD monitor và release evidence. Dùng ở: phần residual risk, degraded behavior và checklist artifact production.
>
> **Nguồn chính:**
>
...
> - [2.13. ISP Image Pipeline for TSR](13.isp_image_pipeline_for_tsr.md) `[SRC]` — Lấy: AE/AWB/demosaic/denoise/HDR/tone/LDC/sharpening và tác động tới frame trước detector. Dùng ở: giải thích nguyên nhân camera/ISP của các trigger blur, glare, exposure, color và geometry.
...
> - [2.06. Sources and Provenance](06.sources_and_provenance.md) `[SRC]` — Lấy: quy ước `[SRC]` và danh mục evidence nội bộ. Dùng ở: tách claim về baseline repo khỏi claim chuẩn SOTIF.
...
>
> **Nguồn tại mục:** [2.09. ODD for TSR](09.odd_for_tsr.md) `[SRC]` — Lấy: phase-1 ODD bounds và out-of-ODD examples. Dùng ở: các trigger weather/lighting/camera/context.
>
...
>
> **Nguồn tại mục:** [2.13. ISP Image Pipeline for TSR](13.isp_image_pipeline_for_tsr.md) `[SRC]` — Lấy: cách các khối ISP như AE, AWB, HDR, tone mapping, lens correction và sharpening tạo ra hoặc giảm nhẹ trigger image-quality. Dùng ở: mapping thuộc tính image quality sang nguyên nhân pipeline.
...
>
> **Nguồn tại mục:** [2.04. Unified Production Reference](04.unified_production_reference.md) `[SRC]` — Lấy: production pattern temporal confirmation, suppression, degraded behavior và context validation. Dùng ở: mitigation examples.
...
> **Nguồn tại mục:** [3.09. Baseline Repo Analysis](../3.implementation/09.baseline_repo_analysis.md) `[SRC]` — Lấy: gap hiện tại về blur/glare, small-object, stale overlay, context/lane/map và evidence RCA. Dùng ở: danh sách residual risk của prototype.
>
> **Nguồn tại mục:** [3.05. Colab Production-Lite Demo](../3.implementation/05.colab_production_lite_demo.md) `[SRC]` — Lấy: notebook đã có quality/ODD gate và event log nhưng chưa đủ production. Dùng ở: phân biệt prototype hiện tại với production-lite mitigation.
