...
> **[SRC] Full reference:**
>
> - [2.01. Unified Production Reference](01.unified_production_reference.md) — Lấy: V-model, work products, release gates và roadmap production. Dùng ở: checklist verification/validation/release của feature TSR.
> - [3.08. Baseline Repo Analysis Full](../3.implementation/08.baseline_repo_analysis_full.md) — Lấy: evidence baseline runtime, missing tests, missing metrics và release gaps. Dùng ở: phần “repo hiện tại đã/chưa có gì”.
>
> **Nguồn chính:**
>
...
> - [2.03. Sources and Provenance](03.sources_and_provenance.md) `[SRC]` — Lấy: quy ước `[SRC]` và danh mục evidence nội bộ. Dùng ở: phân loại evidence nội bộ khi nói về release readiness.
...
> **Nguồn tại mục:** [3.08. Baseline Repo Analysis Full](../3.implementation/08.baseline_repo_analysis_full.md) `[SRC]` — Lấy: baseline hiện mới có demo/runtime characterization, thiếu release discipline. Dùng ở: cảnh báo không đánh giá bằng video đẹp/model card.
>
...
>
> **Nguồn tại mục:** [2.01. Unified Production Reference](01.unified_production_reference.md) `[SRC]` — Lấy: mapping release maturity từ offline demo đến pilot/vehicle validation. Dùng ở: bảng test levels cho TSR.
...
>
> **Nguồn tại mục:** [3.08. Baseline Repo Analysis Full](../3.implementation/08.baseline_repo_analysis_full.md) `[SRC]` — Lấy: KPI/release gap hiện tại. Dùng ở: pattern benchmark/replay cần chuẩn hóa.
...
> **Nguồn tại mục:** [3.05. Baseline Repo Analysis](../3.implementation/05.baseline_repo_analysis.md) `[SRC]` — Lấy: runtime hiện mạnh ở local replay/overlay/manual analysis và thiếu machine-readable benchmark artifacts. Dùng ở: phần prototype hiện mạnh/thiếu.
>
> **Nguồn tại mục:** [3.01. Colab Production-Lite Demo](../3.implementation/01.colab_production_lite_demo.md) `[SRC]` — Lấy: notebook có `events.jsonl`, temporal confirmation lite và KPI proxy. Dùng ở: phần sidecar production-lite.
...
> **Nguồn tại mục:** [3.04. Experiment and Benchmark Guide](../3.implementation/04.experiment_benchmark_guide.md) `[SRC]` — Lấy: nhu cầu khóa benchmark protocol và KPI script dùng chung. Dùng ở: danh sách bước thực dụng cho repo.
>
> **Nguồn tại mục:** [3.07. Colab Production-Lite Demo Full](../3.implementation/07.colab_production_lite_demo_full.md) `[SRC]` — Lấy: JSONL/event schema và temporal confirmation lite từ notebook. Dùng ở: đề xuất đưa schema/logic vào runtime chính.
