...
Tuy nhiên, repo hiện đã có thêm notebook sidecar [Colab Production-Lite Demo](../3.implementation/02.colab_production_lite_demo.md) để mô phỏng một phần các block này ở mức demo:
