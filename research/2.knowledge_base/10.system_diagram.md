...
> **Ngoài phạm vi:** giải thích dài về production mindset, gap baseline hay roadmap; các phần đó nằm ở `12.unified_production_reference.md`.
...
| Nếu bạn cần... | Hãy mở |
|---|---|
| Câu chuyện hệ thống đầy đủ và roadmap production | [Unified Production Reference](12.unified_production_reference.md) |
| Gap implementation của repo hiện tại | [Baseline Repo Analysis Full](../3.implementation/04.baseline_repo_analysis_full.md) |
| Trade-off detector, small-object, edge deploy | [Detector Architecture Deep Reference](13.detector_architecture_deep_reference.md) |
| Demo stateful replay trên Colab | [Colab Production-Lite Demo Full](../3.implementation/05.colab_production_lite_demo_full.md) |
