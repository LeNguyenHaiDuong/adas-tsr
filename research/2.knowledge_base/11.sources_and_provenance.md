...
- **(1)** Narrative chính: [Prototype to Production Narrative](../1.narrative/01.prototype_to_production.md)
- **(2)** Tài liệu production mở rộng: [Unified Production Reference](12.unified_production_reference.md)
- **(3)** Baseline gắn code: [Baseline Repo Analysis Full](../3.implementation/04.baseline_repo_analysis_full.md)
- **(4)** Nghiên cứu kiến trúc detector + edge deployment: [Detector Architecture Deep Reference](13.detector_architecture_deep_reference.md)
- **(5)** Notebook production-lite: [Colab Production-Lite Demo Full](../3.implementation/05.colab_production_lite_demo_full.md)
- Visual appendix: [System Diagram](10.system_diagram.md)
- Slide deck chi tiết: [Slide Deck Extended](../4.presentation/03.slide_deck_full_reference.md)
- Notebook tái lập nhẹ: [06.tsr_research_workflow.ipynb](../3.implementation/06.tsr_research_workflow.ipynb)
- Notebook Colab production-lite: [07.tsr_colab_production_lite_demo.ipynb](../3.implementation/07.tsr_colab_production_lite_demo.ipynb)
...
- Hugging Face dataset card: `star092304/Traffic-sign-detection-VietNam`  
...
- Notebook `07.tsr_colab_production_lite_demo.ipynb`, `README.md`, và dấu vết cục bộ trong checkpoint `best.pt` như `yolo11s.yaml`, `yolo11s.pt`, `traffic_sign_yolo11s`, `data.yaml` được dùng như local corroboration cho provenance của model.
...
- Các nguồn này được dùng để củng cố phần ODD, driving modes, hệ thống state transition, và verification logic trong [Unified Production Reference](12.unified_production_reference.md).
...
- Các nguồn trong mục này hỗ trợ [Detector Architecture Deep Reference](13.detector_architecture_deep_reference.md) cho small-object, edge, dataset và [Unified Production Reference](12.unified_production_reference.md) cho ISA, SOTIF, fusion.
...
- Số liệu dataset trong [Detector Architecture Deep Reference](13.detector_architecture_deep_reference.md) §13.2 được đối chiếu với các trang chính thức trên.
...
- Council Review Summary nằm ở [Unified Production Reference](12.unified_production_reference.md) Phụ lục C.
