...
> **Thứ tự đọc:** 10 — đọc sau [2.07. SOTIF for TSR](07.sotif_for_tsr.md) và trước khi đi sâu vào [3.02. Notebook Analyze](../3.implementation/02.notebook_analyze.md) nếu cần giải thích vì sao frame đầu vào đã bị camera/ISP biến đổi trước khi tới YOLO.
>
...
|---|---|
| [3.02. Notebook Analyze](../3.implementation/02.notebook_analyze.md) `preprocess()` | Software resize/CLAHE sau decode, không phải ISP |
| [3.02. Notebook Analyze](../3.implementation/02.notebook_analyze.md) `assess_frame_quality()` | Quality gate đo hậu quả của ISP/scene trên frame đã xử lý |
| [2.07. SOTIF for TSR](07.sotif_for_tsr.md) `Quality Gate Theo IEEE 2020/P2020` | Cơ sở risk cho image quality, không quy định thuật toán AE/AWB cụ thể |
| [2.06. ODD for TSR](06.odd_for_tsr.md) lighting/weather/camera bounds | Điều kiện mà camera/ISP phải giữ ảnh đủ tin cậy |
| [3.08. Baseline Repo Analysis Full](../3.implementation/08.baseline_repo_analysis_full.md) gap preprocessing | Runtime chính chưa có ISP metadata, quality gate hoặc ISP-aware benchmark |
...
| [2.07. SOTIF for TSR](07.sotif_for_tsr.md) `[SRC]` | Liên hệ ISP/image quality với trigger condition, degraded behavior và validation slice |
| [3.02. Notebook Analyze](../3.implementation/02.notebook_analyze.md) `[SRC]` | Mapping từ frame đã decode sang software preprocessing, quality gate và YOLO input |
