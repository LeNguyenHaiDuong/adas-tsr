...
> **[SRC] Narrative entrypoint:** [Prototype to Production Narrative](../1.narrative/01.prototype_to_production.md) — Lấy: vai trò detector là input cho feature logic, không phải toàn bộ TSR. Dùng ở: mở bài và phần “detector architecture matters nhưng chưa đủ production”.
>
> **[SRC] Bài đọc sâu hơn:** [Detector Architecture Deep Reference](13.detector_architecture_deep_reference.md) — Lấy: chi tiết anchor/head/NMS/multi-scale fusion/edge deployment. Dùng ở: các mục trade-off detector và hướng đọc sâu.
>
> **Nguồn chính:**
>
...
> - [Sources and Provenance](11.sources_and_provenance.md) `[SRC]` — Lấy: quy ước `[SRC]` và danh mục evidence nội bộ. Dùng ở: tách claim kiến trúc detector khỏi evidence baseline repo.

---

## Purpose

> **Nguồn tại mục:** [Detector Architecture Deep Reference](13.detector_architecture_deep_reference.md) `[SRC]` — Lấy: danh sách trade-off detector cần soi cho TSR. Dùng ở: các chủ đề YOLO, RT-DETR, anchor, head, NMS, neck và small-object.
>
...
> **Nguồn tại mục:** [Baseline Repo Analysis](../3.implementation/01.baseline_repo_analysis.md) `[SRC]` — Lấy: checkpoint `best.pt`, YOLO11s, CPU runtime và detector output hiện tại. Dùng ở: mô tả prototype repo.
>
...
>
> **Nguồn tại mục:** [Detector Architecture Deep Reference](13.detector_architecture_deep_reference.md) `[SRC]` — Lấy: small-object, benchmark, architecture-change questions. Dùng ở: ba câu hỏi kiến trúc cuối mục.
...
1. Bài đọc sâu hơn: [Detector Architecture Deep Reference](13.detector_architecture_deep_reference.md) `[SRC]`
2. [Dataset and Benchmark Guide](08.dataset_and_benchmark_guide.md) `[SRC]`
3. [Baseline Repo Analysis](../3.implementation/01.baseline_repo_analysis.md) `[SRC]`
