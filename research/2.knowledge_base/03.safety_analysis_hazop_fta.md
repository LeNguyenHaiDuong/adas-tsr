...
flowchart TD
    ...
    OR1{{"OR"}}
    C1["1. Lỗi nhận diện từ Camera"]
    C2["2. Lỗi xử lý phần cứng ECU"]
    C3["3. Lỗi truyền thông và hiển thị HMI"]
    ...
    ORC1 --> A3["A3: YOLOv8 bỏ sót biển báo"]

    C2 --> ORC2{{"OR"}}
    ORC2 --> B1["B1: Tụt xung nhịp vì quá nhiệt"]
    ORC2 --> B2["B2: Tràn bộ nhớ / OOM"]

    C3 --> ORC3{{"OR"}}
    ORC3 --> B3["B3: Cáp kết nối lỏng hoặc đứt do rung"]
    ORC3 --> B4["B4: CAN Bus nghẽn hoặc trễ quá ngưỡng"]
```
