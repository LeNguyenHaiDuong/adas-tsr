...
<!-- consolidated-from: research/2.knowledge_base/08.state_manager_and_sign_lifecycle.md -->

## Phụ Lục Hợp Nhất Từ `research/2.knowledge_base/08.state_manager_and_sign_lifecycle.md`

> Phần này được gộp từ `research/2.knowledge_base/08.state_manager_and_sign_lifecycle.md` để giữ lại nội dung và traceability sau khi rút gọn cấu trúc Markdown.
...
> **[SRC] Full reference:**
>
> - [2.04. Unified Production Reference](01.automotive_standards.md) — Lấy: policy lifecycle, tracking, arbitration và state transitions. Dùng ở: mô hình `CANDIDATE → CONFIRMED → ACTIVE → STALE/EXPIRED`.
...
>
> **Nguồn tại mục:** [2.04. Unified Production Reference](01.automotive_standards.md) `[SRC]` — Lấy: ranh giới detector output và feature output. Dùng ở: câu “không publish raw detection theo frame”.
...
> **Nguồn tại mục:** [2.04. Unified Production Reference](01.automotive_standards.md) `[SRC]` — Lấy: lifecycle state của sign trong production TSR. Dùng ở: bảng `Candidate`, `Confirmed`, `Active`, `Suppressed`, `Expired`.
>
...
>
> **Nguồn tại mục:** [2.04. Unified Production Reference](01.automotive_standards.md) `[SRC]` — Lấy: pipeline detector → tracking → temporal confirmation → lane/context → active output. Dùng ở: sơ đồ stage pipeline.
...
>
> **Nguồn tại mục:** [2.04. Unified Production Reference](01.automotive_standards.md) `[SRC]` — Lấy: active sign cần lane association, context filtering và policy publish. Dùng ở: stage `Confirmed`, `Active`, `Expired`.
...
>
> **Nguồn tại mục:** [2.04. Unified Production Reference](01.automotive_standards.md) `[SRC]` — Lấy: temporal logic và state manager quyết định publish/suppress/expire. Dùng ở: bước 3-4 của pattern.
...
<!-- consolidated-from: research/2.knowledge_base/12.hmi_diagnostics_and_vehicle_interface.md -->

## Phụ Lục Hợp Nhất Từ `research/2.knowledge_base/12.hmi_diagnostics_and_vehicle_interface.md`

> Phần này được gộp từ `research/2.knowledge_base/12.hmi_diagnostics_and_vehicle_interface.md` để giữ lại nội dung và traceability sau khi rút gọn cấu trúc Markdown.
...
>
> **[SRC] Full reference:** [2.04. Unified Production Reference](01.automotive_standards.md) — Lấy: HMI policy, diagnostics, CAN/service interface và degraded behavior. Dùng ở: các mục output contract, DTC/logging và publish policy.
>
> **Nguồn chính:**
>
...
> **Nguồn tại mục:** [2.04. Unified Production Reference](01.automotive_standards.md) `[SRC]` — Lấy: output contract và HMI/diagnostics boundary của TSR production. Dùng ở: ba nhầm lẫn về bbox, detection event và missing machine-readable diagnosis.
>
...
>
> **Nguồn tại mục:** [2.04. Unified Production Reference](01.automotive_standards.md) `[SRC]` — Lấy: TSR warning ladder là policy feature, không phải AEB trigger. Dùng ở: hai lưu ý về AEB và authority.
...
<!-- consolidated-from: research/2.knowledge_base/14.camera_hazop_sotif.md -->

## Phụ Lục Hợp Nhất Từ `research/2.knowledge_base/14.camera_hazop_sotif.md`

> Phần này được gộp từ `research/2.knowledge_base/14.camera_hazop_sotif.md` để giữ lại nội dung và traceability sau khi rút gọn cấu trúc Markdown.
