...
> **Vai trò mục này:** đặc tả kỹ thuật camera/ISP cho Traffic Sign Recognition dưới mưa, sương mù, chói sáng và ánh sáng LED tại Việt Nam.
>
...
| Operating temperature | Linh kiện và datasheet nên bao phủ môi trường automotive, ví dụ `-40°C` đến `85°C` tùy cấp linh kiện. | Xe 4 bánh chịu nóng khoang cabin/đầu xe, mưa và dao động môi trường mạnh. |
...
| Digital Image Stabilization (DIS) | Bật khi mount/kính chắn gió tạo rung hoặc pitch/roll đáng kể, giữ FOV đủ rộng. | Giảm jitter bbox và giảm false negative do motion blur. | Crop quá nhiều có thể làm mất biển ở rìa frame. |
