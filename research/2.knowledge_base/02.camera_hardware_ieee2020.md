...
2. **EMVA Standard 1288 (Release 4.0):** *Standard for Characterization of Image Sensors and Cameras*. European Machine Vision Association, 2021. [🔗 emva.org/emva-1288](https://www.emva.org/standards-technology/emva-1288/)
3. **ISO 12233:2023:** *Photography — Electronic still picture cameras — Resolution and spatial frequency responses*. International Organization for Standardization. [🔗 iso.org/standard/79048](https://www.iso.org/standard/79048.html)
4. **Sony Semiconductor Solutions:** *IMX390CQV / IMX490 Diagonal 6.67 mm / 8.86 mm CMOS Image Sensors with Simultaneous HDR and LED Flicker Mitigation*. Technical Whitepaper. [🔗 sony-semicon.com/imx390](https://www.sony-semicon.com/en/products/is/automotive/imx390.html)
5. **Onsemi:** *AR0820AT 1/2-inch 8.3 MP CMOS Digital Image Sensor for Automotive ADAS*. Product Datasheet, 2023. [🔗 onsemi.com/ar0820at](https://www.onsemi.com/products/sensors/image-sensors-processors/image-sensors/ar0820at)
6. **NVIDIA Corporation:** *NVIDIA VPI - Vision Programming Interface: Lens Distortion Correction (LDC) Algorithm Reference*. NVIDIA Developer Docs, 2024. [🔗 docs.nvidia.com/vpi](https://docs.nvidia.com/vpi/algo_ldc.html)
