...
| Thuộc tính | Giá trị |
|---|---|
| Narrative chính | [Prototype to Production Narrative](../1.narrative/01.prototype_to_production.md) |
| Brief đầu bài | [0.requirements.md](../0.requirements.md) |
| Script baseline | [`code/tsr_demo.py`](../../code/tsr_demo.py) |
| Model | `models/best.pt` = checkpoint `Ultralytics YOLO11s` fine-tune trên dataset VN `82` class |
| Tài liệu chuyên đề | [Baseline Repo Analysis Full](../3.implementation/04.baseline_repo_analysis_full.md), [Detector Architecture Deep Reference](13.detector_architecture_deep_reference.md), [Colab Production-Lite Demo Full](../3.implementation/05.colab_production_lite_demo_full.md) |
| Tài liệu dẫn xuất | [System Diagram](10.system_diagram.md), [Slide Deck Extended](../4.presentation/03.slide_deck_full_reference.md) |
...
| Nguồn tham khảo | [Sources and Provenance](11.sources_and_provenance.md) |

### 0.1 Thứ tự đọc tài liệu trong `research/`

| # | File | Nội dung |
|---|---|---|
| **0** | `0.requirements.md` | Brief và yêu cầu gốc của bài tập |
| **1** | `1.narrative/01.prototype_to_production.md` | Narrative chính: problem, requirement, prototype, production mapping, gap, roadmap |
| **2** | `2.knowledge_base/00.index.md` | Entry point của Knowledge Base |
| **3** | `3.implementation/00.index.md` | Entry point của implementation layer |
| **4** | `4.presentation/01.slide_storyboard.md` | Storyboard nguồn cho slide |
| **5** | `2.knowledge_base/12.unified_production_reference.md` | Tài liệu production mở rộng (file này) |
| **6** | `2.knowledge_base/13.detector_architecture_deep_reference.md` | Deep-dive detector: anchor, neck, NMS, small-object, dataset, edge deploy |
| **7** | `3.implementation/04.baseline_repo_analysis_full.md` | Annex gắn repo: `tsr_demo.py`, `best.pt`, runtime, gap implementation |
| **8** | `3.implementation/05.colab_production_lite_demo_full.md` | Notebook production-lite: stateful replay, JSONL, quality/ODD gate |
| **9** | `2.knowledge_base/10.system_diagram.md` | Visual appendix và glossary ngắn cho các block kiến trúc |
| **10** | `2.knowledge_base/11.sources_and_provenance.md` | Trích dẫn và provenance |

### 0.2 Cách đọc theo vai trò

| Vai trò | Đọc |
|---|---|
| Người mới TSR | **0** → **1** (Phần I → II → III) → **2** → **3** |
| Tech lead embedded | **1** Phần II (§II.1–II.19) + HTML diagram → **2** → **3** → **4** khi cần stateful replay |
| Chỉ làm code/demo | **README.md** → **1** Phần III → **2** → **4** |
| System architect / perception lead | **1** Phần II đầy đủ → **2**/**3** khi cần trace implementation hoặc detector architecture; dùng **5** như appendix |
...
Nguồn bổ sung: [Intelligent Speed Assistance](https://en.wikipedia.org/wiki/Intelligent_speed_assistance), [MapFusion](https://arxiv.org/abs/2103.05929), [Mapillary TSD](https://arxiv.org/abs/1909.04422)
...
> **KPI gates, release flow và failure RCA chi tiết:** [Baseline Repo Analysis Full](../3.implementation/04.baseline_repo_analysis_full.md) §10–§14. Phần này giữ V-model, gate tổng quan và checklist embedded; không lặp bảng KPI gate §10.1 hoặc release flow §11.
