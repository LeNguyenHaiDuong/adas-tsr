...
> **Thứ tự đọc:** 3 — sau [2.research_tsr_baseline_analysis.md](2.research_tsr_baseline_analysis.md).  
> **File này trả lời:** nếu cần đổi hoặc đánh giá detector cho TSR, nên soi vào những trade-off kiến trúc nào.  
> **Ngoài phạm vi:** kể lại production pipeline TSR từ đầu đến cuối; narrative đó nằm ở [1.research_tsr_three_part_unified.md](1.research_tsr_three_part_unified.md).
...
| Liên kết triển khai repo | [2.research_tsr_baseline_analysis.md](2.research_tsr_baseline_analysis.md) |
| Liên kết narrative hệ thống | [1.research_tsr_three_part_unified.md](1.research_tsr_three_part_unified.md) |
...
Đây là **canonical deep-dive cho perception/detector**. Khi cần trace biểu hiện của các trade-off này trong repo hiện tại, quay lại [2.research_tsr_baseline_analysis.md](2.research_tsr_baseline_analysis.md); khi cần hệ quả system-level lên HMI, diagnostics hay maturity, quay lại [1.research_tsr_three_part_unified.md](1.research_tsr_three_part_unified.md).
