...
> **Ngoài phạm vi:** giải thích đầy đủ production framework, V-model, safety/SOTIF hay kiến trúc tổng thể; phần đó là narrative chính trong [1.research_tsr_three_part_unified.md](1.research_tsr_three_part_unified.md).
...
| Liên kết notebook production-lite | [4.research_tsr_colab_production_lite_demo.md](4.research_tsr_colab_production_lite_demo.md) |
...
Mọi nhận định dưới đây map trực tiếp tới hàm, tham số CLI, hoặc artifact trong repo. Khi cần lý do hệ thống-level "vì sao detector chưa phải feature", quay lại file [1.research_tsr_three_part_unified.md](1.research_tsr_three_part_unified.md); khi cần theory detector, quay lại file [3.research_tsr_detection_architecture_research.md](3.research_tsr_detection_architecture_research.md).
...
Chi tiết về KPI system-level, release gate, scenario catalog, diagnostics và readiness đã được giữ ở [1.research_tsr_three_part_unified.md](1.research_tsr_three_part_unified.md) §II.10–§II.18. Trong file này, các framework đó chỉ còn vai trò **mapping**: repo hiện có thiếu artifact nào và nên bổ sung gì trước.
...
Mô hình trưởng thành đầy đủ đã có trong [1.research_tsr_three_part_unified.md](1.research_tsr_three_part_unified.md). Từ góc nhìn repo, có thể rút gọn thành bảng sau:
